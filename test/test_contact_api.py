...
class TestContactApi(unittest.TestCase):
    ...
    def test_contact_contact_id_delete(self):
        """
        Test case for contact_contact_id_delete

        Deletes a contact
        """
        pass

    def test_contact_contact_id_get(self):
        """
        Test case for contact_contact_id_get

        Find contact by ID
        """
        pass

    def test_contact_contact_id_put(self):
        """
        Test case for contact_contact_id_put
